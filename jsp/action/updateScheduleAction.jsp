...
<%
  ...
  Integer currentUserIdx = Integer.parseInt(request.getParameter("userIdx"));
  ...
  String sql = "UPDATE schedule SET `userIdx` = ?, `startTime` = ?, `endTime` = ?, `content` = ?, `date` = ? WHERE `idx`=?;";
